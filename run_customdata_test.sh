...
## Job name
#SBATCH --job-name=customseg_fullrun
...
CONDA_ENV_NAME="pointscnet_custom_seg_env"
...
DATASET_SAVE_PATH="data/my_custom_scenes_4096pts.npz"
...
echo "--- Starting testing on Custom Data ---"

python test.py \
	--log_dir 'job_2092869/' \
	--num_category 2 \
	--num_point 4096 \
	--data_file_path ${DATASET_SAVE_PATH} \
	--batch_size 24
