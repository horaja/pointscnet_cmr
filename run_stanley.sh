...
#SBATCH --output="/user_data/horaja/workspace/PointSCNet/logs/custom_seg_train_run/job_%j.out"
#SBATCH --error="/user_data/horaja/workspace/PointSCNet/logs/custom_seg_train_run/job_%j.err"
...
CONDA_ENV_NAME="stanley_train_env"
